...
# Matriz de confusão para comparar modelos Supervisionados

```{r}

# Matriz do modelo Multinomial
Conf_Matrix_Mult <- fitted %>%
  conf_mat(truth = observado, estimate = .pred_class)

Conf_Matrix_Mult


# Matriz do modelo XGboost
conf_matrix_xgb <- fitted_bst %>%
  conf_mat(truth = observado, estimate = .pred_class)
